...
Примечание: вопросы отображения переменных на регистры опущен и другие опущены, из-за отсутствия оных.
...
- `wr` -- записать выбранное значение в память:
    ...
    - с порта ввода `input` (обработка на Python):
        ...
        - если буфер пуст -- выбросить исклчение;
...
- Цикл симулции осуществляется в функци `simulation`.
- Шаг моделирования  соответствует одной инструкции с выводом состояния в журнал.
- Для журнала состояний процессора используется стандартный модуль `logging`.
- Количество инструкций для моделирования лимитировано.
- Остановка моделирования осуществляется при:
    - превыение лимита на количество инструкций;
