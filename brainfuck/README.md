...
С точки зрения языка: инструменты работы с переменными и/или константами отсутствуют.
...
В связи с отсутствием переменных и/или констант на уровне языка -- раздел опущен.
