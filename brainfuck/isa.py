...
- `index` -- номер  в машинном коде, необходим для того что бы понимать куда делается условный переход;
...
def read_code(filename):
    ...
    Так как в файле хрянятся не только простейшие типы (`Opcode`, `Term`), мы
